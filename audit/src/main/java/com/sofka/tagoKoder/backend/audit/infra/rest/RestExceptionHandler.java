...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  // Tu 404 de dominio
  @ExceptionHandler(com.sofka.tagoKoder.backend.audit.infra.config.exception.NotFoundException.class)
  public ResponseEntity<ApiResponse<Object>> handleNotFound(com.sofka.tagoKoder.backend.audit.infra.config.exception.NotFoundException ex) {
